...
| 2 | Ownership Category Code | Alphanumeric | 64 | Yes | This is the mapping between the[ Ownership Category](https://digit-discuss.atlassian.net/wiki/spaces/DO/pages/409207542/Ownership+Category) and Sub category |
...
6. In case of any doubt, please reach out to the person who has shared this template with you to discuss and clear your doubts.Firstly get all the sub classifications under a particular classification.
7. Get there codes and start filling the template.
...
| Sr. No. | Checklist Parameter | Example |
| :--- | :--- | :--- |
| 1 | There should be a mapping code between the sub category \(child\) and [Property Tax: Ownership Category](https://digit-discuss.atlassian.net/browse/IP-891)\(parent level\), no child can be left without a parent | - |
| 2 | Make sure that no code which is not mentioned in the ownership category classification \(parent\) can be used | - |

### Attachments <a id="Attachments"></a>

 1. Configurable Data Template -Ownership Sub Type:Configurable Data ...ype.xlsx9 KB

2. Configurable Sample Data Template -Ownership Sub TypeConfigurable Sample Data O...ory.xlsx11 KB

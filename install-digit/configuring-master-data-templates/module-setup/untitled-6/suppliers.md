...
| 11 | GST registered State/UT | Alphanumeric | 15 | Yes | The company/Firm has a multiple businesses with the state or union territory a separate registered GST number is a Tax Identification Number. |
...
Configuration data template - Supplier

Sample configuration data - Supplier

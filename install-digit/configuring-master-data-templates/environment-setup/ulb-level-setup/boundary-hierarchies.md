...
Note: The above-mentioned data for the boundary hierarchy is sample data.
...
1. Configuration Data Template - Boundary Hierarchies

    2. Configuration Sample Data - Boundary Hierarchies

...
| :--- | :--- | :--- | :--- | :--- | :--- |
| 1 | Boundary Code | Alphanumeric | 64 | Yes | The code of the boundary that is being used, depending upon the client's requirement it could be Mohalla or Ward but has to be from the data collected [here](https://digit-discuss.atlassian.net/wiki/spaces/DO/pages/406552674/Boundary+Data) |
| 2 | Boundary Name \(In English\) | Text | 256 | Yes | The name/description of the boundary that is being used for the classification. The names have to be from the data collected [here](https://digit-discuss.atlassian.net/wiki/spaces/DO/pages/406552674/Boundary+Data) |
...
Configurable Data Template - Pr... V1.xlsx9 KB

 2. Configurable Sample Data - Property Tax Unit RatesConfigurable Sample Data - Pro... V1.xlsx10 KB

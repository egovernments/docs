...
* **Open Source** - DIGIT is Open Source and has been built using the best-in-class Open Source technology stacks powering the most advanced companies in the world. DIGIT ensures the lowest total cost of ownership and helps ensure that governments retain strategic control of their systems and data.
...
{% content-ref url="platform/architecture/" %}

...
* [Deployment Docs](setup/devops/README.md)
  * [Setup Requirements](setup/devops/setup-digit/README.md)
    ...
    * [Tech Enablement Training \(eDCR\) - Essential Skills and Prerequisites](setup/devops/setup-digit/tech-enablement-training-edcr-essential-skills-and-prerequisites.md)
    * [DIGIT Rollout Program Governance](setup/devops/setup-digit/digit-rollout-program-governance.md)
    * [DevOps Skills Requirements](setup/devops/setup-digit/devops-skills.md)
    * [Infra Requirements](setup/devops/setup-digit/cluster-requirements.md)
    * [Team Composition for DIGIT Implementation](setup/devops/setup-digit/team-composition-for-digit-implementation.md)
    * [Infra Best Practices](setup/devops/setup-digit/devops.md)
    * [Operational Best practices](setup/devops/setup-digit/operational-best-practices.md)
    * [Why Kubernetes for DIGIT](setup/devops/setup-digit/why-kubernetes-for-digit.md)
  * [Supported Clouds](setup/devops/infra-structure-overview/README.md)
    * [Google Cloud](setup/devops/infra-structure-overview/google-cloud-platform.md)
    * [Azure](setup/devops/infra-structure-overview/azure.md)
    * [AWS](setup/devops/infra-structure-overview/infra-provisioning-aws.md)
    * [VSphere](setup/devops/infra-structure-overview/vsphere.md)
    * [SDC](setup/devops/infra-structure-overview/sdc-state-data-center.md)
    * [NIC](setup/devops/infra-structure-overview/nic-national-informatica-cloud.md)
  * [Deployment - Key Concepts](setup/devops/deployment-key-concepts/README.md)
    * [Security Practices](setup/devops/deployment-key-concepts/security-practices.md)
    * [CI/CD](setup/devops/deployment-key-concepts/cicd.md)
    * [Readiness & Liveness](setup/devops/deployment-key-concepts/probes.md)
    * [Resource Requests & Limits](setup/devops/deployment-key-concepts/resource-requests-and-limits.md)
  * [Understanding ERP Stack](setup/devops/understanding-erp-stack/README.md)
    * [ERP Monolithic Architecture](setup/devops/understanding-erp-stack/erp-monolithic-architecture.md)
    * [ERP Hybrid Architecture](setup/devops/understanding-erp-stack/erp-hybrid-architecture.md)
    * [ERP Coexistence Architecture](setup/devops/understanding-erp-stack/erp-coexistence-architecture.md)
    * [APMDP-HYBRID-INFRA-ARCHITECTURE](setup/devops/understanding-erp-stack/apmdp-hybrid-infra-architecture.md)
    * [eGov SmartCity eGovernance Suite](setup/devops/understanding-erp-stack/egov-smartcity-egovernance-suite.md)
    * [ERP Deployment Process](setup/devops/understanding-erp-stack/erp-deployment-process.md)
    * [ERP Release Process](setup/devops/understanding-erp-stack/erp-release-process.md)
    * [ERP User Guide](setup/devops/understanding-erp-stack/erp-user-guide.md)
  * [Deploying DIGIT Services](setup/devops/digit-deployment-on-aws/README.md)
    * [Deployment Architecture](setup/devops/digit-deployment-on-aws/deployment-architecture.md)
    * [Routing Traffic](setup/devops/digit-deployment-on-aws/routing-traffic.md)
    * [Backbone Deployment](setup/devops/digit-deployment-on-aws/backbone-deployment.md)
  * [Troubleshooting](setup/devops/troubleshooting/README.md)
    * [Distributed Tracing](setup/devops/troubleshooting/distributed-tracing.md)
    * [Logging](setup/devops/troubleshooting/logging.md)
    * [Monitoring & Alerts](setup/devops/troubleshooting/monitoring.md)

...
* [Deploy DIGIT](deploy-flow/README.md)
  * [Infra Specifications](deploy-flow/infra-specifications/README.md)
    * [Infra Requirements](deploy-flow/infra-specifications/cluster-requirements.md)
    * [Why Kubernetes for DIGIT](deploy-flow/infra-specifications/why-kubernetes-for-digit.md)
    * [Supported Clouds](deploy-flow/infra-specifications/infra-structure-overview/README.md)
      * [Google Cloud](deploy-flow/infra-specifications/infra-structure-overview/google-cloud-platform.md)
      * [Azure](deploy-flow/infra-specifications/infra-structure-overview/azure/README.md)
        * [Provision Infra](deploy-flow/infra-specifications/infra-structure-overview/azure/infra-provisioning-azure.md)
      * [AWS](deploy-flow/infra-specifications/infra-structure-overview/infra-provisioning-aws.md)
      * [VSphere](deploy-flow/infra-specifications/infra-structure-overview/vsphere.md)
      * [SDC](deploy-flow/infra-specifications/infra-structure-overview/sdc-state-data-center.md)
      * [NIC](deploy-flow/infra-specifications/infra-structure-overview/nic-national-informatica-cloud.md)
    * [Infra Sizing](deploy-flow/infra-specifications/estimating-infra.md)
    * [Infra Best Practices](deploy-flow/infra-specifications/devops.md)

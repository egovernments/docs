...
* [Deployment Docs](deployment/devops/README.md)
  * [Setup Requirements](deployment/devops/setup-digit/README.md)
    * [Tech Enablement Training - Essential Skills and Pre-requisites](deployment/devops/setup-digit/tech-enablement-training-essential-skills-and-pre-requisites.md)
    * [Tech Enablement Training \(eDCR\) - Essential Skills and Prerequisites](deployment/devops/setup-digit/tech-enablement-training-edcr-essential-skills-and-prerequisites.md)
    * [DIGIT Rollout Program Governance](deployment/devops/setup-digit/digit-rollout-program-governance.md)
    * [DevOps Skills Requirements](deployment/devops/setup-digit/devops-skills.md)
    * [Infra Requirements](deployment/devops/setup-digit/cluster-requirements.md)
    * [Team Composition for DIGIT Implementation](deployment/devops/setup-digit/team-composition-for-digit-implementation.md)
    * [Infra Best Practices](deployment/devops/setup-digit/devops.md)
    * [Operational Best practices](deployment/devops/setup-digit/operational-best-practices.md)
    * [Why Kubernetes for DIGIT](deployment/devops/setup-digit/why-kubernetes-for-digit.md)
  * [Supported Clouds](deployment/devops/infra-structure-overview/README.md)
    * [Google Cloud](deployment/devops/infra-structure-overview/google-cloud-platform.md)
    * [Azure](deployment/devops/infra-structure-overview/azure.md)
    * [AWS](deployment/devops/infra-structure-overview/infra-provisioning-aws.md)
    * [VSphere](deployment/devops/infra-structure-overview/vsphere.md)
    * [SDC](deployment/devops/infra-structure-overview/sdc-state-data-center.md)
    * [NIC](deployment/devops/infra-structure-overview/nic-national-informatica-cloud.md)
  * [Deployment - Key Concepts](deployment/devops/deployment-key-concepts/README.md)
    * [Security Practices](deployment/devops/deployment-key-concepts/security-practices.md)
    * [CI/CD](deployment/devops/deployment-key-concepts/cicd.md)
    * [Readiness & Liveness](deployment/devops/deployment-key-concepts/probes.md)
    * [Resource Requests & Limits](deployment/devops/deployment-key-concepts/resource-requests-and-limits.md)
  * [Understanding ERP Stack](deployment/devops/understanding-erp-stack/README.md)
    * [ERP Monolithic Architecture](deployment/devops/understanding-erp-stack/erp-monolithic-architecture.md)
    * [ERP Hybrid Architecture](deployment/devops/understanding-erp-stack/erp-hybrid-architecture.md)
    * [ERP Coexistence Architecture](deployment/devops/understanding-erp-stack/erp-coexistence-architecture.md)
    * [APMDP-HYBRID-INFRA-ARCHITECTURE](deployment/devops/understanding-erp-stack/apmdp-hybrid-infra-architecture.md)
    * [eGov SmartCity eGovernance Suite](deployment/devops/understanding-erp-stack/egov-smartcity-egovernance-suite.md)
    * [ERP Deployment Process](deployment/devops/understanding-erp-stack/erp-deployment-process.md)
    * [ERP Release Process](deployment/devops/understanding-erp-stack/erp-release-process.md)
    * [ERP User Guide](deployment/devops/understanding-erp-stack/erp-user-guide.md)
  * [Deploying DIGIT Services](deployment/devops/digit-deployment-on-aws/README.md)
    * [Deployment Architecture](deployment/devops/digit-deployment-on-aws/deployment-architecture.md)
    * [Routing Traffic](deployment/devops/digit-deployment-on-aws/routing-traffic.md)
    * [Backbone Deployment](deployment/devops/digit-deployment-on-aws/backbone-deployment.md)
  * [Troubleshooting](deployment/devops/troubleshooting/README.md)
    * [Distributed Tracing](deployment/devops/troubleshooting/distributed-tracing.md)
    * [Logging](deployment/devops/troubleshooting/logging.md)
    * [Monitoring & Alerts](deployment/devops/troubleshooting/monitoring.md)

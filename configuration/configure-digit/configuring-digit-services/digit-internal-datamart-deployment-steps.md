...
1. **Install Kubectl**\
   ...
   &#x20;[Kubernetes Installation Doc](https://kubernetes.io/docs/tasks/tools/install-kubectl/)\
   &#x20;[Kubernetes Ubuntu Installation](https://matthewpalmer.net/kubernetes-app-developer/articles/install-kubernetes-ubuntu-tutorial.html)
...
| **OBPS (Bpa)**  | <p><a href="https://github.com/egovernments/utilities/tree/Rain-3035/datamart/obps/bpa">bpa.py</a><br><br></p> | <p>bpaDatamart.csv<br><br></p> |                            |
